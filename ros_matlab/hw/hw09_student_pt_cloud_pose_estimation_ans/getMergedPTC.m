...
%--------------------------------------------------------------------------
    ...
    for iter = 1:length(locations)
        ...
        % to center object. 
        elseif iter > 5
             displaceGA = displace_gripper(mat_R_T_G,optns,locations{iter},0.07,1,0.05); % Rotate flag on. Parameter is 0.05 rad
        end
        ...
        % c) Merge world and recent point cloud (world+above)
    ...
    %% To reset move arm back to original position (per zone)
